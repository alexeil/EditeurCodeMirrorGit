...
public class IHMcodeMirror_V4 implements EntryPoint,MirrorEditorCallback {
            ...
            public void onClick(ClickEvent event) {
                ...
                repositoryToolsServices.createRepository(login,password, nomRepository, new AsyncCallback<Boolean>(){
                    ...
                    @Override public void onSuccess(Boolean aBoolean) {
                        ...
                        repositoryToolsServices.updateContentFileAndCommit("hello the world".getBytes(), login, new AsyncCallback<Boolean>() {
                            @Override
                            public void onFailure(Throwable throwable) {
                                //To change body of implemented methods use File | Settings | File Templates.
                            }
                            ...
                            public void onSuccess(Boolean aBoolean) {
                                repositoryToolsServices.pushRepository(login,password, new AsyncCallback<Boolean>() {
                                    ...
                                    public void onSuccess(Boolean aBoolean) {
                                        loadFileSystem();
                                        System.out.println("Youhou ! commit push done");
                                    }
                                });
                            }
                        });
    ...
    public void loadFileSystem() {
        ...
        systemFileService.getArborescence(new AsyncCallback<AbstractItem>() {
